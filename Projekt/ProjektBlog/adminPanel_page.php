...
<div class="container" id="Panel">
    <form method="POST" action="commentsManagment_page.php">
        <input class="btn btn-primary" type="submit" value="Manage Comments">
    </form>

    <form method="POST" action="usersManagment_page.php">
        <input class="btn btn-primary" type="submit" value="Manage users">
    </form>
