...
<div class="container" id="posts">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $sql2 = "SELECT * FROM comments INNER JOIN users ON comments.Users_id=users.Users_id WHERE Posts_id=?";
            ...
            if ($result2->num_rows > 0) {
                while ($row2 = $result2->fetch_assoc()) {
                    ...
                    <form method="POST" action="deleteComment.php">
                        ...
                        <input type="hidden" name="selectedComment_id" value="<?php echo $row2["Comments_id"] ?>">
